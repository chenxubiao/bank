package cn.longhaiyan.common.filter;

import cn.longhaiyan.common.utils.WebUtil;
...
public class BasicFilter implements Filter {
    public static final String HOST_suffix = ".longhaiyan.cn";
    public static final String HOST = "bank" + HOST_suffix;
...
//        response.setHeader("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept");
    ...
    private final void setGloableAttributes(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (request.getAttribute(BankConsts.USER_SESSION_KEY) == null) {
            request.setAttribute("BankConsts.USER_SESSION_KEY", null);
        }
