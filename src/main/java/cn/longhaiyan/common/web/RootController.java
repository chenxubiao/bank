...
public class RootController {
    ...
    public void deleteUserSession(HttpServletRequest request) {
        request.getSession().setAttribute(BankConsts.USER_SESSION_KEY, null);
    }
    ...
    public UserSession getUserSession(HttpServletRequest request) {
        if(request != null) {
            UserSession userSession = (UserSession) request.getSession().getAttribute(BankConsts.USER_SESSION_KEY);
            if(userSession != null) {
                return userSession;
            }
        }
